...
//
// Honest limitation: this syncs PLAYERS, not the WORLD. Published games
// (in /games/, see publishedGames.js) are identical for everyone since
// they're the same static file, so multiplayer works as expected there.
// A custom project only lives in its creator's LocalStorage — other
// players joining that room will see each other moving around, but only
// see the same building/objects if they happen to have loaded an
// identical copy of that project (e.g. via export/import). True shared
// worlds need a cloud save system, which isn't built yet (see the
// roadmap).
// ===========================================================
